(* Headless runner for the PRIMARY module: 00-BBT-blackbox-protocol/mbqc_c5.wl
   ...
   central research question (see 00-BBT-blackbox-protocol/README.md) -- the
   ...
   Python, run directly:  python3 ../00-BBT-blackbox-protocol/mbqc_blackbox_test.py *)
SetDirectory[DirectoryName[$InputFileName]];
Get["../00-BBT-blackbox-protocol/mbqc_c5.wl"]
