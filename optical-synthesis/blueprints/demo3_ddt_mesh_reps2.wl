<|"TargetSpec" -> <|"Word" -> "ddt", "Reps" -> 2|>, "ModeCount" -> 18, 
 "Layer" -> "Mesh", "Stages" -> {<|"Type" -> "Block", "Index" -> 0, 
    "Modes" -> {1, 2, 3}, "Letter" -> "d", "Label" -> "P1"|>, 
   <|"Type" -> "Block", "Index" -> 1, "Modes" -> {4, 5, 6}, "Letter" -> "d", 
    "Label" -> "P2"|>, <|"Type" -> "Block", "Index" -> 2, 
    "Modes" -> {7, 8, 9}, "Letter" -> "t", "Label" -> "P3"|>, 
   <|"Type" -> "Block", "Index" -> 3, "Modes" -> {10, 11, 12}, 
    "Letter" -> "d", "Label" -> "P4"|>, <|"Type" -> "Block", "Index" -> 4, 
    "Modes" -> {13, 14, 15}, "Letter" -> "d", "Label" -> "P5"|>, 
   <|"Type" -> "Block", "Index" -> 5, "Modes" -> {16, 17, 18}, 
    "Letter" -> "t", "Label" -> "P6"|>}, 
 "Routing" -> {<|"From" -> 0, "To" -> 1, "SharedModes" -> {1, 2}, 
    "Orientation" -> "direct"|>, <|"From" -> 1, "To" -> 2, 
    "SharedModes" -> {4, 5}, "Orientation" -> "direct"|>, 
   <|"From" -> 2, "To" -> 3, "SharedModes" -> {7, 8}, 
    "Orientation" -> "twisted"|>, <|"From" -> 3, "To" -> 4, 
    "SharedModes" -> {10, 11}, "Orientation" -> "direct"|>, 
   <|"From" -> 4, "To" -> 5, "SharedModes" -> {13, 14}, 
    "Orientation" -> "direct"|>}, "IntensitySchedule" -> Missing[], 
...
(ddt_cluster_dla.wl) and is a separate, open item."|>|>, 
 "Provenance" -> <|"Targets" -> <|"Word" -> "ddt", "Reps" -> 2|>, 
