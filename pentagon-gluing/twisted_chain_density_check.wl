(* In-Wolfram verification of the twisted-chain bulk density conjecture, at m
   values far beyond the existing Python evidence (m=50..800, with ~0.01
   boundary-transient noise at small m). Reuses twistedChainWL[m] and
   ...
   Target: twistedDensityLimit = tauStar = 1.376717745915859 (exact algebraic
...
Do[
  Module[{t, theta},
    {t, theta} = AbsoluteTiming[LovaszThetaSparse[twistedChainWL[m]]];
