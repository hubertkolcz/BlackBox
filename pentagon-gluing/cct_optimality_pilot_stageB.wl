(* cct-optimality PILOT, STAGE B (window realism / decisive decomposition).
...
words = {"cct", "ctt", "cttt", "cctt", "ccttt", "t"};
...
report[EpsilonCertificate, 7, "k=7 (EpsilonCertificate, bottleneck cttt)"];
report[EpsilonCertificate8, 8, "k=8 (EpsilonCertificate8, bottleneck ctt)"];
