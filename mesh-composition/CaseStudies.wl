...
(* ::Input:: *)
Get[FileNameJoin[{Quiet@Check[NotebookDirectory[], Directory[]], "..", "certificates", "EpsilonCertificate.wl"}]];
...
(* ::Input:: *)
Get[FileNameJoin[{Quiet@Check[NotebookDirectory[], Directory[]], "..", "certificates", "EpsilonCertificate8.wl"}]];
